...
| ------------- | ---------------------------------- | --------------------------------------------------------------------- |
| Angular 9     | `npm i --save ngx-ui-loader`       | [v9.x.x](https://tdev.app/ngx-ui-loader/demo)                         |
| Angular 8     | `npm i --save ngx-ui-loader@8.0.0` | [v8.x.x](https://tdev.app/ngx-ui-loader/demo)                         |
